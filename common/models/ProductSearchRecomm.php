 ...
 * @property  int $fromId
 */
class ProductSearchRecomm extends Product
{
    public $fromId;
    /**
     * {@inheritdoc}
    ...
    {
        return [
            [['id', 'price', 'code', 'avail', 'unlimited', 'count', 'sale', 'hot', 'new', 'rank', 'publish', 'rating', 'reviews_count', 'hits'], 'integer'],
    ...
    public function search($params)
    {
        ...
        if (RecommendedProduct::getSelectedProdId($this->fromId)){
            $query->andWhere(['not in', 'id', RecommendedProduct::getSelectedProdId($this->fromId)]);
        }
